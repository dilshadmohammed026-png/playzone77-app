import { collection, doc, getDoc, getDocs, setDoc, deleteDoc, updateDoc, addDoc, increment, query, orderBy, onSnapshot } from 'firebase/firestore';
...
export interface AppSettings {
  ...
  adCodeStickyBanner?: string;
  adCodeInterstitial?: string;
  ...
  try {
    ...
    if (docSnap.exists()) {
      ...
      return {
        ...
        adCodeBanner: data.adCodeBanner || '',
