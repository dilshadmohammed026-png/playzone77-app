...
export function AdZone({ code, enabled = true, adUnit }: AdZoneProps) {
  ...
  let containerClasses = "w-full max-w-full flex justify-center items-center overflow-x-auto mt-2.5";
  let wrapperClasses = "w-full flex flex-col items-center justify-center py-5 px-4 my-6 bg-gradient-to-b from-[#041208]/80 to-[#020a04]/90 border border-green-900/30 rounded-2xl shadow-inner max-w-full overflow-hidden relative";

  if (adUnit === 'top_banner' || adUnit === 'footer_banner') {
    wrapperClasses += " max-w-[760px] mx-auto";
    containerClasses += " min-h-[50px] md:min-h-[90px] max-w-[728px]";
  } else if (adUnit === 'middle_banner') {
    wrapperClasses += " max-w-[340px] mx-auto";
    containerClasses += " min-h-[250px] max-w-[300px]";
  } else if (adUnit === 'sidebar_banner') {
    wrapperClasses += " max-w-[340px] h-full min-h-[300px] lg:min-h-[600px] mx-auto";
    containerClasses += " min-h-[250px] lg:min-h-[500px] max-w-[300px]";
  }
